...
export const filterProducts = (productsToRender, selectedTypes, selectedGender, selectedPrice, roundedHighestPrice) => {
...
if (selectedGender !== '') {
  ...
  //   );
  // });
  filteredProducts = filteredProducts?.filter((product) => (product.name).toLowerCase().includes(selectedGender)
)
}
